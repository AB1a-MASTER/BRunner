...
// // Dynamic Layout Switching Pipeline
...
//   if (request.type === "COLLAPSE_SIDEBAR") {
//     mainView.style.display = "none";
//     studioView.style.display = "flex";
//   }

//   if (request.type === "EXPAND_SIDEBAR") {
//     studioView.style.display = "none";
//     mainView.style.display = "flex";
//     loadWorkflows(); // Automatically sync with local OS disk storage
//   }
// });
...
// // Listen for minimize commands from the Orchestration Engine
// chrome.runtime.onMessage.addListener((request) => {
//   if (request.type === "COLLAPSE_SIDEBAR") {
//     console.log(
//       "[BRunner Sidebar] Collapsing layout due to active Studio session.",
//     );

//     // Smoothly replace the sidebar content with a minimalist placeholder panel
//     document.body.innerHTML = `
//       <div style="padding: 25px; font-family: system-ui, sans-serif; text-align: center; color: #94a3b8; background: #0f172a; height: 100vh; display: flex; flex-direction: column; justify-content: center; align-items: center; box-sizing: border-box;">
//         <div style="font-size: 2.5rem; margin-bottom: 15px;">🛠️</div>
//         <h4 style="margin: 0 0 10px 0; color: #3b82f6;">Studio IDE Active</h4>
//         <p style="font-size: 0.8rem; line-height: 1.4; margin: 0;">Sidebar controls are hidden while the full canvas is open to optimize your workspace layout.</p>
//       </div>
//     `;
//   }
// });

// // --- NEW: JIT View State Calibration on Panel Initialization ---
// async function initializePanelLayout() {
//   try {
//     // Query the tab that the user is looking at right now
//     const [activeTab] = await chrome.tabs.query({
//       active: true,
//       currentWindow: true,
//     });
...
//     if (activeTab && activeTab.url && activeTab.url.startsWith(studioUrl)) {
//       mainView.style.display = "none";
//       studioView.style.display = "flex";
//     } else {
//       studioView.style.display = "none";
...
//     }
//   } catch (err) {
//     console.error("[BRunner Sidebar] Initialization alignment failed:", err);
//   }
// }
...
//       // Safely re-trigger your file list rendering if the function is declared above
//       if (typeof loadWorkflows === "function") {
//         loadWorkflows();
//       }
//     }
...
// // Force immediate state calculation upon loading the sidebar window
